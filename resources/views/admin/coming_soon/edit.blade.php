	          		...
	          		<form action="{{ action('ComingSoonController@update') }}" method="POST" enctype="multipart/form-data">
		                ...
		                <div class="row">
		                  ...
		                  <div class="col-md-6">
		                    ...
		                    <input value="{{ isset($comingsoon['heading']) }}" name="heading" type="text" class="form-control" placeholder="Enter Page Title" required/>
		                    <br>
		                    <label for="btn_text">{{ __('adminstaticword.ButtonText') }}<sup class="redstar">*</sup></label>
		                    <input value="{{ isset($comingsoon['btn_text'] )}}" name="btn_text" type="text" class="form-control" placeholder="Enter Button Text" required/>
