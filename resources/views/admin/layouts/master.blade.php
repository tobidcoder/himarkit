...
<body class="hold-transition skin-blue sidebar-mini fixed">
  ...
  <div class="wrapper">
    ...
    @if(Auth::user()->role == 'instructor' || Auth::user()->role = 'user')
      ...
      <button type="button" class="btn btn-primary" data-whatever="@mdo"><a style="color: white" href="{{ route('contact')}}"> Send Feedback </a> </button>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form  action="{{ route('feedbackpost')}}" method="POST">
                  ...
                  <input type="text" name="name" value="{{Auth::user()->fname}} {{Auth::user()->lname}}" class="form-control" id="email">
                  </div>
                  <div class="form-group">
                    <label for="message-text" class="col-form-label">Description:</label>
                    <textarea name="description" class="form-control" id="message-text">Enter Description</textarea>
                  </div>
                </form>
              </div>
