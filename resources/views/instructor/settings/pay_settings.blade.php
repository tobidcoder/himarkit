	          	...
	          	<div class="panel-body">
	            	...
	            	<br>
                        ...
                        <div class="row">
                        	...
                        	<div id="bankpayment" @if($user->prefer_pay_method == "banktransfer" || $user->prefer_pay_method == "banktransfer" ) @endif class="" >
			                <div class="col-md-6">
