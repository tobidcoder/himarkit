          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                ...
                <div> 
                  <h4> What to feature your course! </h4>
                  <b><P> Call / WhatsApp: 08131035860 or E-mail: feature@himarkit.com </p></b>
                  <label for="total_amount">NOTE: Amount to be paid to feature a course:</sup></label>&nbsp;
                  <b><i class="{{ $currency->icon }}"></i>&nbsp;{{ $gsetting->feature_amount }}</b>
                </div>
